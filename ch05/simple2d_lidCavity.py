...
CAES description: Steady Lid-driven cavity flow 
  test: RE=100/400/2000/5000, (20,20), pass
#       RE=100, (50,50), pass
"""
...
# ------------------------------ global variables------------------------------
### problme state
subFolder = "results_case1/"
problemTitle = "cavity_simplecol"
isAxisXSymmetry = 0
isUnsteady = 0
...
### physical setting
RE = 100.; rho_ref = 1.; uLID = 1.
vis_ref = rho_ref*uLID*(xeast-xwest)/RE
nu = vis_ref/rho_ref
