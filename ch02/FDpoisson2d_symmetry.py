...
if __name__ == "__main__":
    ...
    while (istep<maxstep):
        ...
        if (istep == 1 or istep%200 == 0):
            figname = "laplace2d_symmetry_%04d.jpg" %(istep)
    ...
    ### after converged
    errorHisFileName = "case2_error_history.csv"
    ...
    resultsFileName = "case2_steady_solution.mat"
    resultsFileName = subFolder + resultsFileName
    scio.savemat(resultsFileName, dict([('x', x), ('y', y), ('fi', fi)]))

    figname = "converged_laplace2d_symmetry_%04d.jpg" %(istep)
    figname = subFolder + figname
    userSurface3D(x, y, fi, figname, ' ')
